...
define('WAP_CIRCLE_SITE_URL', $config['wap_circle_site_url']);
...
//--------新增---------
define('LIB_PATH', './framework/libraries/');
define('FUNCTION_PATH', './framework/function/');
//spread system
//define('SPREAD_SITE_URL', 'http://spread.test.gellefreres.com/gf/rebate/queryRebate.htm');
define('SPREAD_SITE_URL', 'http://www.pre.gellefreres.com/rebate/queryRebate.htm');
define('OLDEVENT_FAZHI', 100000);
//-----------------
