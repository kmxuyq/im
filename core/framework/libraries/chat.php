...
// define('CHAT_TEMPLATES_URL', 'http://127.0.0.1:8090');
class Chat
{
    public static function getChatHtml($layout, $mobile)
    {
        $web_html = '';
        if ($layout != 'layout/msg_layout.php' && $layout != 'layout/store_joinin_layout.php') {
            ...
            $web_html = <<<EOT
            <link href="{$css_url}/css/{$css}.css" rel="stylesheet" type="text/css">
...
EOT;
            ...
            if ($mobile == 1) {
                $web_html .= '<script type="text/javascript" src="' . CHAT_RESOURCE_URL . '/js/user_mobile.js" charset="utf-8"></script>';
            } else {
