...
final class Base{
	...
	private static function start_session(){
		...
		if ($subdomain_suffix !== 'localhost') {
		    if($_SERVER['SERVER_NAME']=='m.test.gellefreres.com' ||
		    	$_SERVER['SERVER_NAME']=='m.gellefreres.com') {
		    	@ini_set('session.cookie_domain', '.gellefreres.com');
		    } else {
	...
	private static function cp(){
		...
		if ($_SERVER['HTTP_HOST'] == 'm.gellefreres.com') return;
