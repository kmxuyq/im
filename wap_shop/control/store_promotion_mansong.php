...
class store_promotion_mansongControl extends BaseSellerControl {
    ...
    public function mansong_saveOp() {
        ...
        if($mansong_id) {
            ...
            showDialog(Language::get('mansong_add_success'), urlShopWAP('store_promotion_mansong', 'mansong_list'), 'succ');
        } else {
    ...
    public function mansong_delOp() {
        ...
        if($result) {
            ...
            showDialog(L('nc_common_op_succ'), urlShopWAP('store_promotion_mansong', 'mansong_list'), 'succ');
        } else {
    ...
    public function mansong_quota_add_saveOp() {
        ...
        showDialog(Language::get('mansong_quota_add_success'), urlShopWAP('store_promotion_mansong', 'mansong_list'), 'succ');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'mansong_list','menu_name'=>Language::get('promotion_active_list'),'menu_url'=>urlShopWAP('store_promotion_mansong', 'mansong_list')),
        );
        switch ($menu_key){
        	case 'mansong_add':
                $menu_array[] = array('menu_key'=>'mansong_add','menu_name'=>Language::get('promotion_join_active'),'menu_url'=>urlShopWAP('store_promotion_mansong', 'mansong_add'));
        		break;
        	case 'mansong_quota_add':
                $menu_array[] = array('menu_key'=>'mansong_quota_add','menu_name'=>Language::get('promotion_buy_product'),'menu_url'=>urlShopWAP('store_promotion_mansong', 'mansong_quota_add'));
        		break;
        	case 'mansong_detail':
                $menu_array[] = array('menu_key'=>'mansong_detail','menu_name'=>Language::get('mansong_active_content'),'menu_url'=>urlShopWAP('store_promotion_mansong', 'mansong_detail', array('mansong_id' => $_GET['mansong_id'])));
        		break;
        }
