...
class store_waybillControl extends BaseSellerControl{
    ...
    public function waybill_bind_saveOp() {
        ...
        if($result) {
            showMessage('绑定成功', urlShopWAP('store_waybill', 'waybill_manage'));
        } else {
    ...
    public function waybill_setting_saveOp() {
        ...
        if($result) {
            showDialog(L('nc_common_save_succ'), urlShopWAP('store_waybill', 'waybill_manage'), 'succ');
        } else {
    ...
    public function waybill_saveOp() {
        ...
        if(!isset($result['error'])) {
            showDialog(L('nc_common_save_succ'), urlShopWAP('store_waybill', 'waybill_list'), 'succ');
        } else {
            showDialog(L('nc_common_save_fail'), urlShopWAP('store_waybill', 'waybill_list'));
        }
    }
    ...
    private function profile_menu($menu_key = '') {
        ...
        $menu_array[] = array(
            ...
            'menu_name' => '模板绑定',
            'menu_url' => urlShopWAP('store_waybill', 'waybill_manage')
        );
        $menu_array[] = array(
            'menu_key' => 'waybill_list',
            'menu_name' => '自建模板',
            'menu_url' => urlShopWAP('store_waybill', 'waybill_list')
        );
        if($menu_key == 'waybill_bind') {
            $menu_array[] = array(
                'menu_key' => 'waybill_bind',
                'menu_name' => '选择模板',
                'menu_url' => urlShopWAP('store_waybill', 'waybill_bind')
            );
        }
        if($menu_key == 'waybill_setting') {
            $menu_array[] = array(
                ...
                'menu_name' => '模板设置',
                'menu_url' => urlShopWAP('store_waybill', 'waybill_setting')
            );
        }
        if($menu_key == 'waybill_add') {
            $menu_array[] = array(
                ...
                'menu_name' => '添加模板',
                'menu_url' => urlShopWAP('store_waybill', 'waybill_add')
            );
        }
        if($menu_key == 'waybill_edit') {
            $menu_array[] = array(
                ...
                'menu_name' => '编辑模板',
                'menu_url' => urlShopWAP('store_waybill', 'waybill_edit')
            );
        }
        if($menu_key == 'waybill_design') {
            $menu_array[] = array(
                ...
                'menu_name' => '设计模板',
                'menu_url' => urlShopWAP('store_waybill', 'waybill_design')
            );
        }
