    ...
    private function _exchange() {
        if (chksubmit()) {
            ...
            if ($update) {
                ...
                $order_info['goods_url'] = urlShopWAP('goods','index',array('goods_id' => $order_info['goods_id']));
                $order_info['order_url'] = urlShopWAP('store_vr_order','show_order',array('order_id' => $order_info['order_id']));
