...
class store_snsControl extends BaseSellerControl{
	...
	private function profile_menu($menu_key) {
		$menu_array	= array(
				...
				3=>array('menu_key'=>'store_sns_brower', 'menu_name'=>Language::get('store_sns_browse'), 'menu_url'=>urlShopWAP('store_snshome', 'index', array('sid' => $_SESSION['store_id'])), 'target'=>'_blank')
		);
