...
class predepositControl extends BaseMemberControl {
    ...
    public function rechargecard_addOp()
    {
        ...
        try {
            ...
            showMessage('平台充值卡使用成功', urlShopWAP('predeposit', 'rcb_log_list'));
        } catch (Exception $e) {
    ...
    public function indexOp(){
        ...
        $list = $model_pd->getPdRechargeList($condition,5,'*','pdr_id desc');
	...
	public function pd_log_listOp(){
		...
		$list = $model_pd->getPdLogList($condition,5,'*','lg_id desc');
