...
<div class="wrapper mt10">
  <div class="ncs-main-container">
    ...
    <div class="content ncs-all-goods-list mb15">
      <ul>
	  <?php var_dump($output['recommended_goods_list']);?>
        <?php foreach($output['recommended_goods_list'] as $value){?>
        <li>
          <dl>
            <dt><a href="<?php echo urlShopWAP('goods', 'index',array('goods_id'=>$value['goods_id']));?>" class="goods-thumb" target="_blank">
			<img src="<?php echo thumb($value, 240);?>" alt="<?php echo $value['goods_name'];?>" /></a>
			...
			<a href="<?php echo urlShopWAP('goods', 'index', array('goods_id'=>$value['goods_id']));?>" title="<?php echo $value['goods_name'];?>" target="_blank"><?php echo $value['goods_name']?></a></dd>
