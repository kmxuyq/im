...
class store_goods_addControl extends BaseSellerControl {
    ...
    public function save_goodsOp() {
        if (chksubmit()) {
            ...
            if ($error != '') {
                showMessage(L('error') . $error, urlShopWAP('seller_center'), 'html', 'error');
            }
 		...
 		require_once(BASE_RESOURCE_PATH.DS.'phpqrcode'.DS.'index.php');
		    ...
		    $PhpQRCode->set('date',WAP_SITE_URL . '/tmpl/product_detail.html?goods_id='.$goods_id);
                ...
                redirect(urlShopWAP('store_goods_add', 'add_step_three', array('commonid' => $common_id)));
            } else {
    ...
    public function save_imageOp(){
        if (chksubmit()) {
            ...
            if ($rs) {
                redirect(urlShopWAP('store_goods_add', 'add_step_four', array('commonid' => $common_id)));
            } else {
