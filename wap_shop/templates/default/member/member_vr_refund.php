                ...
                <div class="refund">
                    ...
                    <div class="refund_main">
                        ...
                        <div class="refund_numb">
							...
							<a href="index.php?act=member_vr_refund&op=view&refund_id=<?php echo $val['refund_id']; ?>" >
                        ...
                        <div class="refund_text">
                            ...
                            <div class="text">
								...
								<a href="index.php?act=member_vr_order&op=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank">
                        ...
                        <ul class="refund_state">
                            <li style="float:left;width:98%">审核状态:<?php echo $output['admin_array'][$val['admin_state']]; ?></li>   
                        </ul>
                    </div>
