...
<div class="wrap">
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td></td>
        <td class="w50"><div class="pic-thumb"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id'=>$val['inform_goods_id']));?>" target="_blank"><img src="<?php echo cthumb($val['inform_goods_image'],60,$val['inform_store_id']);?>" onMouseOver="toolTip('<img src=<?php echo cthumb($val['inform_goods_image'],160,$val['inform_store_id']); ?>>')" onMouseOut="toolTip()"/></a></div></td>
        <td class="tl"><dl class="goods-name">
            <dt><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id'=>$val['inform_goods_id']));?>" target="_blank"> <?php echo $val['inform_goods_name']; ?> </a></dt>
            <dd>商家：<a href="<?php echo urlShopWAP('show_store','index',array('store_id'=>$val['inform_store_id']));?>"><?php echo $val['inform_store_name']; ?></a> </dd>
          </dl></td>
