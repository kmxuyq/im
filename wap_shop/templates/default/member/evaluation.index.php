  ...
  <form id="goodsevalform" method="get" class="tc">
    ...
    <div class="ncm-evaluation-list">
      ...
      <div class="ncm-evaluation-timeline">
        ...
        <div class="goods-thumb"><a target="_blank" href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $v['geval_goodsid']));?>"> <img src="<?php echo cthumb($v['geval_goodsimage'], 60);?>"> </a></div>
        <dl class="detail">
          <dt><a target="_blank" href="<?php echo urlShopWAP('goods', 'index', array('goods_id'=>$v['geval_goodsid'])); ?>"><?php echo $v['geval_goodsname']?></a> </dt>
          <dd>商品评分：
          ...
          <dd>
            ...
            <a href="<?php echo urlShopWAP('member_evaluate', 'add_image', array('geval_id' => $v['geval_id']));?>" class="ncm-btn ncm-btn-orange">我要晒单</a>
            <?php } ?>
            <?php if (!empty($v['geval_image'])){?>
            晒图图片：
            <ul class="photos-thumb">
              ...
              <li> <a nctype="nyroModal"  href="<?php echo C('remote_upload_url').$value;?>"> <img src="<?php echo C('remote_upload_url').$value;?>"> </a> </li>
              <?php } ?>
            </ul>
            <?php }?>
          </dd>
