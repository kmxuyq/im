  ...
  <div class="outline">
    ...
    <div class="ncm-favorites-goods">
      <ul id="favoritesGoodsList" class="jcarousel-skin-tango">
        ...
        <li>
          <div class="ncm-goods-thumb-120"><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$favorites['goods']['goods_id']));?>" target="_blank"><img alt="" src="<?php echo thumb($favorites['goods'], 240);?>"></a>
            <div class="ncm-goods-price"><em>￥<?php echo ncPriceFormat($favorites['goods']['goods_price']);?></em></div>
          </div>
          <div class="ncm-goods-name"><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$favorites['goods']['goods_id']));?>" title="<?php echo $favorites['goods']['goods_name'];?>" target="_blank"><?php echo $favorites['goods']['goods_name'];?></a></div>
        </li>
        <?php } ?>
      </ul>
  ...
  <div class="outline">
    ...
    <div class="ncm-favorites-store">
      <ul id="favoritesStoreList" class="jcarousel-skin-tango">
        ...
        <li>
          <div class="ncm-store-pic"><a href="<?php echo urlShopWAP('show_store', 'index', array('store_id' => $favorites['store']['store_id']), $favorites['store']['store_domain']);?>" ><img alt="" src="<?php echo getStoreLogo($favorites['store']['store_avatar']);?>"></a></div>
          <dl>
            <dt class="ncm-goods-name"><a href="<?php echo urlShopWAP('show_store', 'index', array('store_id' => $favorites['store']['store_id']), $favorites['store']['store_domain']);?>" title="<?php echo $favorites['store']['store_name'];?>" ><?php echo $favorites['store']['store_name'];?></a></dt>
