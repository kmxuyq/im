  ...
  <form method="post" action="index.php?act=member_snsindex&op=sharegoods" id="sharegoods_form">
    ...
    <div class="share-content">
      ...
      <div class="share-goods">
        <div class="goods-thumb"><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>"> <img title="<?php echo $output['goods_info']['goods_name']; ?>" src="<?php echo thumb($output['goods_info'],240);?>" /></a></div>
        <dl class="goods-intro">
          <dt><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>"><?php echo $output['goods_info']['goods_name']; ?></a></dt>
...
<div class="bottom"><a href="javascript:void(0);" nc_type="finishbtn" data-param='{"apikey":"@apikey"}' class="mini-btn"><?php echo $lang['sharebind_list_finishbind'];?></a><span><?php echo $lang['sharebind_list_unfinishedbind'];?><a target="_blank" href="<?php echo WAP_SHOP_SITE_URL;?>/api.php?act=sharebind&type=@apikey"><?php echo $lang['sharebind_list_againbind'];?></a></span>
</div>
</div>
</textarea>
