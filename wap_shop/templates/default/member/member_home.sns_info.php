    ...
    <div class="outline">
      ...
      <?php if (!empty($output['follow_list']) && is_array($output['follow_list'])) { ?>
       <div class="ncm-friends-share">
            ...
            <div class="more"><a target="_blank" href="<?php echo WAP_SHOP_SITE_URL?>/index.php?act=member_snsfriend&op=follow">查看我的全部好友</a></div>
          </div>
     <?php } else { ?>
      <dl class="null-tip">
        <dt></dt>
        <dd>
          ...
          <p><a target="_blank" href="<?php echo WAP_SHOP_SITE_URL?>/index.php?act=member_snsfriend&op=follow" class="ncm-btn-mini" >查看我的全部好友</a></p>
        </dd>
      </dl>
    <?php } ?>  
    </div>
  ...
  <div id="browseMark" class="normal">
    <div class="outline">
      ...
      <div class="ncm-browse-mark">
            ...
            <div class="more"><a href="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=member_goodsbrowse&op=list" target="_blank">查看所有商品</a></div>
          </div>
       <?php } else { ?>
          <dl class="null-tip">
            <dt></dt>
            <dd>
              <h4>您的商品浏览记录为空</h4>
              <h5>赶紧去商城看看促销活动吧</h5>
              <p><a target="_blank" href="<?php echo WAP_SHOP_SITE_URL;?>" class="ncm-btn-mini">浏览商品</a></p>
            </dd>
          </dl>
       <?php } ?>
    </div>
