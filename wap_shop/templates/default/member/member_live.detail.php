...
<div class="ncm-oredr-show">
  <div class="ncm-order-info">
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        ...
        <li>2. 去商城看看新的<a href="<?php echo urlShopWAP('show_live_groupbuy','index');?>" class="ncm-btn-mini ncm-btn-green" target="_blank">抢购</a>活动。</li>
      </ul>
    </div>
    <!-- E 全部兑换完成订单 -->
    <?php }?>
    <div class="mall-msg">有疑问可咨询<a href="javascript:void(0);" onclick="ajax_form('mall_consult', '平台客服', '<?php echo urlShopWAP('member_mallconsult', 'add_mallconsult', array('inajax' => 1));?>', 640);"><i class="icon-comments-alt"></i>平台客服</a></div>
  </div>
  ...
  <div class="ncm-order-contnet">
    <table class="ncm-default-table order">
      ...
      <tr>
        <th colspan="20"><span class="ml10" title="线下抢购订单编号">线下抢购单号：<?php echo $output['order']['order_sn'];?></span><span>下单时间：<?php echo date("Y-m-d H:i",$output['order']['add_time']);?></span><span><a href="<?php echo urlShopWAP('show_store','index',array('store_id'=>$output['store']['store_id']));?>"  target="_blank" title="<?php echo $output['store']['store_name'];?>"><?php echo $output['store']['store_name'];?></a></span> 
          <!-- QQ --> 
      ...
      <tbody>
      <td class="bdl"></td>
        <td class="w50"><div class="pic-thumb"><a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$output['order']['groupbuy_id']));?>" target="_blank" onMouseOver="toolTip('<img src=<?php echo lgthumb($output['order']['groupbuy_pic'], 'small');?>>')" onMouseOut="toolTip()"/><img src="<?php echo lgthumb($output['order']['groupbuy_pic'], 'small');?>"/></a></div></td>
        <td class="tl"><dl class="goods-name">
            <dt><a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$output['order']['groupbuy_id']));?>" target="_blank" title="<?php echo $val['item_name'];?>"><?php echo $output['order']['item_name'];?></a></dt>
