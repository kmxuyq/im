                ...
                <div class="refund">
                    ...
                    <div class="refund_main">
                        ...
                        <div class="refund_numb">
                            <span>
							<?php echo $lang['return_order_returnsn'].$lang['nc_colon'];?>
		                    <?php echo $val['refund_sn']; ?>
							</span>
							<?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 1) { ?>
							  <a href="index.php?act=member_return&op=ship&return_id=<?php echo $val['refund_id']; ?>" >
						       <input value="退货" type="button"/>
						      </a>
							<?php } else { ?>
							  <a href="index.php?act=member_return&op=view&return_id=<?php echo $val['refund_id']; ?>" >
						        <input value="退货" type="button"/>
						      </a>
							<?php } ?>
                        ...
                        <div class="refund_text">
                            ...
                            <div class="text">
                                ...
                                <p>数量:<?php echo $val['return_type'] == 2 ? $val['goods_num']:'无';?>（<span style="color:red">￥<?php echo $val['refund_amount'];?></span>）</p>
                                <p>
                        ...
                        <ul class="refund_state">
                            ...
                            <li style="float:left;width:48%">平台确认:<?php echo ($val['seller_state'] == 2 && $val['refund_state'] >= 2) ? $output['admin_array'][$val['refund_state']]:'无'; ?></li>
                        </ul>
                    </div>
