...
<div class="wrap">
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"><span class="ml5"><?php echo $lang['favorite_store_name'].$lang['nc_colon'];?><a href="<?php echo urlShopWAP('show_store','index',array('store_id'=> $goods_list[0]['goods']['store_id']), $favorites['goods']['store_domain']);?>" ><?php echo $goods_list[0]['goods']['store_name'];?></a>
