...
<div class="wrap">
  ...
  <table class="ncm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"><span class="ml10">线下抢购单号：<?php echo $val['order_sn'];?></span><span>下单时间：<?php echo date("Y-m-d H:i",$val['add_time']);?></span><span><a href="<?php echo urlShopWAP('show_store','index',array('store_id'=>$val['store_id']));?>"  target="_blank" title="<?php echo $val['store_name'];?>"><?php echo $val['store_name'];?></a></span> 
          <!-- QQ --> 
      ...
      <tr>
        <td class="bdl"></td>
        <td class="w70"><div class="ncm-goods-thumb"><a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$val['groupbuy_id']));?>" target="_blank" onMouseOver="toolTip('<img src=<?php echo lgthumb($val['groupbuy_pic'], 'small');?>>')" onMouseOut="toolTip()"/><img src="<?php echo lgthumb($val['groupbuy_pic'], 'small');?>"/></a></div></td>
        <td class="tl"><dl class="goods-name">
            <dt><a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$val['groupbuy_id']));?>" target="_blank" title="<?php echo $val['item_name'];?>"><?php echo $val['item_name'];?></a></dt>
