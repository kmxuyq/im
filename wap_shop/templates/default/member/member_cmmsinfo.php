...
<div class="counseling respond_list">
	<div class="counseling_dec">
        <span class="counseling_respond">提现金额：<?php echo $output['info']['amount']; ?> <?php echo $lang['currency_zh']; ?></span>
    </div>

	<div class="counseling_dec">
        <span class="counseling_respond">开户银行：<?php echo $output['info']['bank_name']; ?></span>
    </div>

	<div class="counseling_dec">
        <span class="counseling_respond">银行卡号：<?php echo $output['info']['bank_no']; ?></span>
    </div>

	<div class="counseling_dec">
        <span class="counseling_respond">开户姓名：<?php echo $output['info']['bank_user']; ?></span>
    </div>

	<div class="counseling_dec">
        <span class="counseling_respond">申请日期：<?php echo @date('Y-m-d',$output['info']['addtime']); ?></span>
    </div>

	<div class="counseling_dec">
        <span class="counseling_respond">状态：<?php echo str_replace(array('0','1','2'),array('审核中','已审核','已支付'),$output['info']['status']);?></span>
    </div>
