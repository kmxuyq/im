  ...
  <div class="outline">
    ...
    <div class="order-list">
      <ul>
        ...
        <li>
          <div class="ncm-goods-thumb"><a target="_blank" href="<?php echo urlShopWAP('member_order','show_order',array('order_id'=>$order_info['order_id'])); ?>"><img src="<?php echo thumb($order_info['extend_order_goods'][0],60); ?>" /></a><em><?php echo count($order_info['extend_order_goods'])>1 ? count($order_info['extend_order_goods']) : null;?></em></div>
          <dl class="ncm-goods-info">
            <dt><a href="<?php echo urlShopWAP('member_order','show_order',array('order_id'=>$order_info['order_id'])); ?>" target="_blank"><?php echo $order_info['extend_order_goods'][0]['goods_name']; ?></a>
          ...
          <a href="<?php echo urlShopWAP('member_order','show_order',array('order_id'=>$order_info['order_id'])); ?>" target="_blank" class="ncm-btn">确认收货</a>
          <?php } ?>
  ...
  <div class="outline">
    ...
    <div class="cart-list">
      <ul>
        ...
        <li>
          <div class="ncm-goods-thumb"><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$cart_info['goods_id']));?>"><img src="<?php echo thumb($cart_info,60);?>"></a></div>
          <dl class="ncm-goods-info">
            <dt><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$cart_info['goods_id']));?>"><?php echo $cart_info['goods_name']; ?></a></dt>
