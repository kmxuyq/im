    ...
    public function indexOp() {
        ...
        if ($_GET['state_type'] != '') {
            $condition['order_state'] = str_replace(
                    array('state_new','state_pay','state_success','state_cancel','state_noeval'),
                    array(ORDER_STATE_NEW,ORDER_STATE_PAY,ORDER_STATE_SUCCESS,ORDER_STATE_CANCEL,ORDER_STATE_SUCCESS), $_GET['state_type']);
