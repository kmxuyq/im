<?php defined('InShopNC') or exit('Access Invalid!');?>
  ...
  <div class="ncm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="ncm-goods-thumb-mini"><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=> $output['order']['goods_id'])); ?>">
        ...
        <dd><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=> $output['order']['goods_id'])); ?>"><?php echo $output['order']['goods_name']; ?></a>
