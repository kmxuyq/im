  ...
  <div id="ncmInformFlow" class="ncm-flow-container">
    ...
    <div class="ncm-default-form">
      ...
      <form id="add_form" enctype="multipart/form-data" method="post" action="index.php?act=member_inform&op=inform_save">
        ...
        <dl>
          <dt>被举报商家：</dt>
          <dd><a href="<?php echo urlShopWAP('show_store','index',array('store_id'=>$output['goods_info']['store_id']));?>" target="_blank";><?php echo $output['goods_info']['store_name'];?></a></dd>
        </dl>
        <dl>
          <dt><?php echo $lang['inform_goods_name'].$lang['nc_colon'];?></dt>
          <dd>
            <div class="ncm-inform-item">
              <div class="ncm-goods-thumb-mini"><a href="<?php echo urlShopWAP('goods', 'index',array('goods_id'=>$output['goods_info']['goods_id']));?>" target="_blank"><img src="<?php echo thumb($output['goods_info'],60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($output['goods_info'],240); ?>>')" onMouseOut="toolTip()" /></a></div>
              <a href="<?php echo urlShopWAP('goods', 'index',array('goods_id'=>$output['goods_info']['goods_id']));?>" target="_blank"> <?php echo $output['goods_info']['goods_name']; ?> </a></div>
          </dd>
        </dl>
        <dl>
