...
<header class="ui-header ui-header-positive qz-header-background qz-header-bb noProsition">
    <i class="ui-icon-return" onclick="location.href = 'index.php?act=member_order&state_type=state_new'"></i>
    <h1 class="qz-color">取消订单</h1>
    <span class="top_menu_ico"><i class="fa fa-navicon"></i></span>
</header>
<form method="post" id="form-box" action="index.php?act=member_order&op=change_state&state_type=order_cancel&order_id=<?php echo $output['order_info']['order_id']; ?>" >
...
<div class="order_number_wrap">
    ...
    <ul class="order_number_choose">
        ...
        <li class="item">
            <input class="choose_radio" name="state_info" id="d2" value="<?php echo $lang['member_change_other_shipping'];?>" type="button"/>
            <span><?php echo $lang['member_change_other_shipping'];?></span>
        </li>
        <li class="item">
            <input class="choose_radio" name="state_info" id="d3" value="<?php echo $lang['member_change_other_store'];?>" type="button" />
		...
		<div id="state_info1"style="display:none">
