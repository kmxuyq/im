...
<div class="ncm-flow-item">
  ...
  <div class="item-goods">
    <?php if (is_array($output['goods_list']) && !empty($output['goods_list'])) { ?>
      ...
      <dl>
        <dt>
          <div class="ncm-goods-thumb-mini"><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=> $val['goods_id'])); ?>">
            <img src="<?php echo thumb($val,60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($val,240); ?>>')" onMouseOut="toolTip()" /></a></div>
        </dt>
        <dd><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=> $val['goods_id'])); ?>"><?php echo $val['goods_name']; ?></a>
  ...
  <div class="item-order">
    ...
    <dl class="line">
      ...
      <dd> <a href="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=member_order&op=show_order&order_id=<?php echo $output['order']['order_id'];?>"  target="_blank"> <?php echo $output['order']['order_sn'];?> </a> <a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
