    ...
    <ul>
      ...
      <li class="shop-item" id="recordone_<?php echo $v['share_id']; ?>">
        ...
        <div class="shop-content">
          ...
          <div class="info">
            <div class="title"><a title="<?php echo $v['store_name'];?>" href="<?php echo urlShopWAP('show_store', 'index', array('store_id'=>$v['store_id']));?>"><i class="ico" ></i><?php echo $v['store_name'];?></a>
            </div>
          </div>
          <div class="detail">
          ...
          <div class="operate">
            ...
            <div class="button"><span><a href="<?php echo urlShopWAP('show_store', 'index', array('store_id'=>$v['store_id']));?>"><?php echo $lang['sns_round_store'];?></a></span><span><a href="javascript:collect_store('<?php echo $v['store_id'];?>','count','store_collect')"><?php echo $lang['sns_collect_store'];?></a></span></div>
          </div>
...
$(function(){
	...
	$('#snssharestore').click(function(){
	    ajax_form("sharestore", '<?php echo $lang['sns_sharestore'];?>', '<?php echo WAP_SHOP_SITE_URL.DS;?>index.php?act=member_snsindex&op=sharestore', 480);
	    return false;
	});
});
</script>
