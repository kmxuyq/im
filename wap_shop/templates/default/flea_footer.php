...
<div id="faq">
  <div class="faq-wrapper">
   ...
   <li> <dl class="s<?php echo ''.$k+1;?>">
      ...
      <dd><i></i><a href="<?php if($article['article_url'] != '')echo $article['article_url'];else echo urlShopWAP('article', 'show',array('article_id'=> $article['article_id']));?>" title="<?php echo $article['article_title']; ?>"> <?php echo $article['article_title'];?> </a></dd>
      <?php }?>
      <?php }?>
    </dl></li>
    <?php }?>
...
<div id="footer" class="wrapper">
  <p><a href="<?php echo WAP_SHOP_SITE_URL;?>"><?php echo $lang['nc_index'];?></a>
