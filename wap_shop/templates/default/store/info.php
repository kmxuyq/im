...
<?php } ?>
    ...
    <div class="goto"><a href="<?php echo urlShopWAP('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" >进入商家店铺</a><a href="javascript:collect_store('<?php echo $output['store_info']['store_id'];?>','count','store_collect')" >收藏店铺<em nctype="store_collect"><?php echo $output['store_info']['store_collect']?></em></a></div>
    ...
    <ul>
      ...
      <li class="ncs-info-btn-qrcode"><a href="javascript:void(0)" class="pngFix"><span>店铺二维码</span><b></b> <!-- 店铺二维码//zmr>v30 -->
        <p class="ncs-info-qrcode"><img src="<?php echo storeQRCode($output['store_info']['store_id']);?>" title="店铺原始地<?php echo urlShopWAP('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id']));?>" style="width:208px;height:208px"></p>
        </a></li>
    </ul>
    </div> 
  </div>
