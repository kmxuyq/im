...
<div class="ncs-goods-info-content" nctype="gbc_content">
    ...
    <div class="F-center">
      ...
      <div class="ncs-bundling-list">
        <ul>
          ...
          <li>
            <div class="goods-thumb"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $v['id']));?>" target="block"><img src="<?php echo $v['image'];?>" title="<?php echo $v['name'];?>" alt="<?php echo $v['name'];?>"/></a></div>
            <dl>
              <dt title="<?php echo $v['name'];?>"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $v['id']));?>" target="block"><?php echo $v['name'];?></a></dt>
  ...
  <div class="ncs-combo-container" <?php if ($current) {?>style="display:none;"<?php }?>>
    <div class="default-goods">
      <div class="goods-thumb"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $output['goods_info']['goods_id']));?>" target="block"><img src="<?php echo thumb($output['goods_info'], 240);?>" title="<?php echo $output['goods_info']['goods_name'];?>" alt="<?php echo $output['goods_info']['goods_name'];?>"/></a></div>
      <dl>
        <dt title="<?php echo $output['goods_info']['goods_name'];?>"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $output['goods_info']['goods_id']));?>" target="block"><?php echo $output['goods_info']['goods_name'];?></a></dt>
    ...
    <div class="combo-goods-list" nctype="combo_list">
      <ul>
        ...
        <li <?php if ($j == 0) {?>class="combo-goods-first"<?php $j++;}?>>
          <div class="goods-thumb"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $combo['goods_id']));?>" target="block"><img src="<?php echo thumb($combo, 240);?>" title="<?php echo $combo['goods_name'];?>" alt="<?php echo $combo['goods_name'];?>" onload="javascript:DrawImage(this,100,100);" /></a></div>
          <dl>
            <dt title="<?php echo $combo['goods_name'];?>"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $combo['goods_id']));?>" target="block"><?php echo $combo['goods_name'];?></a></dt>
            <dd>
