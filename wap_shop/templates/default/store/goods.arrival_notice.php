...
<div class="recommend">
  ...
  <ul>
    ...
    <li>
      <dl>
        <dt><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $value['goods_id']));?>" target="_blank" title="<?php echo $value['goods_jingle'];?>"><img src="<?php echo thumb($value, 240);?>" alt="<?php echo $value['goods_name'];?>"/></a><em><?php echo $lang['currency'];?><?php echo $value['goods_price'];?></em></dt>
        <dd><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $value['goods_id']));?>" target="_blank" title="<?php echo $value['goods_name'];?><?php echo $value['goods_jingle'];?>"><?php echo $value['goods_name'];?></a></dd>
      </dl>
    </li>
    <?php }?>
  </ul>
