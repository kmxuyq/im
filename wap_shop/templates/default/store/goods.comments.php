...
<div class="tr pr5 pb5 pr">
  <a href="<?php echo urlShopWAP('goods', 'comments_list', array('goods_id' => $_GET['goods_id']));?>" target="_blank" class="more-commend">查看全部评价>></a><div class="pagination"> <?php echo $output['show_page'];?></div>
</div>
<?php }else{?>
