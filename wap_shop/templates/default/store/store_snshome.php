...
<div class="cms-sns">
  <div class="cms-sns-left">
    <div class="cms-sns-tabmene">
      <ul>
        <li><a href="<?php echo urlShopWAP('store_snshome', 'index', array('sid' => $output['store_info']['store_id']));?>" <?php if($_GET['type'] == ''){?>class="selected"<?php }?>><?php echo $lang['store_sns_all_trends'];?><i></i></a></li>
        <li><a href="<?php echo urlShopWAP('store_snshome', 'index', array('sid' => $output['store_info']['store_id'], 'type' => 'promotion'));?>" <?php if($_GET['type'] == 'promotion'){?>class="selected"<?php }?>><?php echo $lang['store_sns_sales_promotion'];?><i></i></a></li>
        <li><a href="<?php echo urlShopWAP('store_snshome', 'index', array('sid' => $output['store_info']['store_id'], 'type' => 'new'));?>" <?php if($_GET['type'] == 'new'){?>class="selected"<?php }?>><?php echo $lang['store_sns_new_goods'];?><i></i></a></li>
        <li><a href="<?php echo urlShopWAP('store_snshome', 'index', array('sid' => $output['store_info']['store_id'], 'type' => 'hotsell'));?>" <?php if($_GET['type'] == 'hotsell'){?>class="selected"<?php }?>><?php echo $lang['store_sns_hot_sale'];?><i></i></a></li>
        <li><a href="<?php echo urlShopWAP('store_snshome', 'index', array('sid' => $output['store_info']['store_id'], 'type' => 'recommend'));?>" <?php if($_GET['type'] == 'recommend'){?>class="selected"<?php }?>><?php echo $lang['store_sns_recommended'];?><i></i></a></li>
      </ul>
    </div>
    ...
    <div class="cms-sns-right-container">
      ...
      <div class="cms-favorites-user">
        <ul>
          ...
          <li><a target="_blank" href="<?php echo urlShopWAP('member_snshome', 'index', array('mid'=>$val['member_id']));?>"><img alt="<?php echo $val['member_name'];?>" title="<?php echo $val['member_name'];?>" src="<?php echo getMemberAvatarForID($val['member_id']);?>" /></a></li>
          <?php }?>
        </ul>
      </div>
    </div>
