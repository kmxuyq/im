...
TipBox.prototype.renderUI = function(tipType){   
    ...
    tipType == 'image' && this.imageRenderUI();   
    tipType == 'html' && this.htmlRenderUI();   
...
//图片效果UI  
TipBox.prototype.imageRenderUI = function(){  
    var suc = "";   
    TipBox.prototype.boundingBox.append(suc);  
}; 
//html效果UI  
TipBox.prototype.htmlRenderUI = function(){  
    var suc = "";   
    TipBox.prototype.boundingBox.append(suc);  
}; 
