...
<ul class="goods-list">
  ...
  <li><dl class="goods-info">
    <dt class="goods-pic"> <a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>"> <img src="<?php echo cthumb($v['goods_image'], 240,$v['store_id']);?>" alt="<?php echo $v['goods_name'];?>" title="<?php echo $v['goods_name'];?>"/> </a> </dt>
    <dd class="goods-name"><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$v['goods_id']));?>"><?php echo $v['goods_name'];?></a> </dd>
