...
<div class="nch-container wrapper">
  <div class="nch-all-menu">
    <ul class="tab-bar">
      <li><a href="<?php echo urlShopWAP('category', 'index');?>">全部商品分类</a></li>
      <li class="current"><a href="javascript:void(0);">全部品牌</a></li>
      <li><a href="<?php echo urlShopWAP('search', 'index');?>">全部商品</a></li>
    </ul>
  </div>
  ...
  <div class="nch-recommend-borand">
    ...
    <div class="nch-barnd-list">
      <ul>
        ...
        <li>
          <dl>
            <dt><a href="<?php echo urlShopWAP('brand', 'list', array('brand'=>$brand_r['brand_id']));?>"><img src="<?php echo brandImage($brand_r['brand_pic']);?>" alt="<?php echo $brand_r['brand_name'];?>" /></a></dt>
            <dd><a href="<?php echo urlShopWAP('brand', 'list', array('brand'=>$brand_r['brand_id']));?>"><?php echo $brand_r['brand_name'];?></a></dd>
          </dl>
        </li>
        <?php }?>
      </ul>
  ...
  <div class="nch-brand-class">
    ...
    <div class="nch-barnd-list tabs-panel <?php if ($i != 1) { echo 'tabs-hide';} ?>">
      <ul>
        ...
        <li>
          <dl>
            <dt><a href="<?php echo urlShopWAP('brand', 'list', array('brand'=>$brand['brand_id']));?>"><img src="<?php echo brandImage($brand['brand_pic']);?>" alt="<?php echo $brand['brand_name'];?>"/></a></dt>
            <dd><a href="<?php echo urlShopWAP('brand', 'list', array('brand'=>$brand['brand_id']));?>"><?php echo $brand['brand_name'];?></a></dd>
          </dl>
        </li>
        <?php }?>
        <?php }?>
      ...
      <div class="nch-barnd-list-text"><strong>更多品牌：</strong>
        ...
        <a href="<?php echo urlShopWAP('brand', 'list', array('brand'=>$brand['brand_id']));?>"><?php echo $brand['brand_name'];?></a>
        <?php } ?>
      </div>
      <?php } ?>
    </div>
