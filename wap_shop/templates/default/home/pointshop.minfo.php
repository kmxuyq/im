...
<div class="ncp-member-grade">
  ...
  <?php } ?>
  <div class="links">
    <div class="links"> <a href="<?php echo urlShopWAP('pointgrade','index');?>" target="_blank">我的成长进度</a> <a href="<?php echo urlShopWAP('pointgrade','exppointlog');?>" target="_blank">经验值明细</a> </div>
  </div>
</div>
