...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo urlShopWAP(); ?>">首页</a> </span> <span class="arrow">></span> <span>商城抢购</span></div>
</div>
  ...
  <div class="ncg-content">
    ...
    <div class="group-list mt20">
      <div class="ncg-recommend-title">
        <h3>线上抢购推荐</h3>
        <a href="<?php echo urlShopWAP('show_groupbuy', 'groupbuy_list'); ?>" class="more">查看更多</a></div>
    ...
    <div class="group-list mt30">
      <div class="ncg-recommend-title">
        <h3>虚拟抢购推荐</h3>
        <a href="<?php echo urlShopWAP('show_groupbuy', 'vr_groupbuy_list'); ?>" class="more">查看更多</a></div>
