...
<div class="content" nc_type="current_display_mode">
  ...
  <ul class="nch-booth-list squares">
    ...
    <li nctype_goods="<?php echo $value['goods_id'];?>" nctype_store="<?php echo $value['store_id'];?>">
        ...
        <?php }?>
          <div class="goods-name"><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$value['goods_id']));?>" target="_blank" title="<?php echo $value['goods_jingle'];?>"><?php echo $value['goods_name'];?></a></div>
