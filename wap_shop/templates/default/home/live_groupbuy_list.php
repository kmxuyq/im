    ...
    <div class="group-list">
      <ul>
        ...
        <li class="<?php echo $output['current'];?>">
          ...
          <a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" class="pic-thumb" target="_blank"><img src="<?php echo lgthumb($groupbuy['groupbuy_pic'],'mid');?>" alt=""></a>
          ...
          <div class="item-prices"> <span class="price"><i><?php echo $lang['currency'];?></i><em><?php echo $groupbuy['groupbuy_price'];?></em></span>
            ...
            <span class="sold-num"> <em><?php echo $groupbuy['buyer_num'];?></em>次<?php echo $lang['text_buy'];?> </span> <a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" target="_blank" class="buy-button">我要抢</a> </div>
        </li>
        <?php } ?>
      </ul>
    </div>
