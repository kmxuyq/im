...
<div id="KinSlideshow" style="visibility:hidden;">
  ...
  <div class="ad"><script type="text/javascript" src="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1038"></script></div> 
  ...
  <div id="fourth_items">
    <h2></h2>
    <ul>
      <li class="fn-left"><script type="text/javascript" src="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1043"></script></li>
      <li class="fn-left"><script type="text/javascript" src="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1044"></script></li>
      <li class="fn-left"><script type="text/javascript" src="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1045"></script></li>
      <li class="last fn-left"><script type="text/javascript" src="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1046"></script></li>
    </ul>
  </div>
  <div class="fn-clear"></div>
  <div id="five_items">
