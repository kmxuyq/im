...
<div class="breadcrumb"><span class="icon-home"></span><span><a href="<?php echo WAP_SHOP_SITE_URL;?>">首页</a></span> <span class="arrow">></span> <span>商家入驻申请</span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3>商家入驻申请</h3>
        ...
        <dd style="display:none;">
          <ul>
            ...
            <li> <i></i>
              ...
              <a href="<?php echo urlShopWAP('show_help', 'index', array('t_id' => $v['type_id'],'help_id' => $v['help_id']));?>" target="_blank"><?php echo $v['help_title'];?></a>
              <?php }else { ?>
