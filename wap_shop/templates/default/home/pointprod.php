...
<div class="ncp-container">
  ...
  <div class="ncp-main-layout">
    <div class="title">
      ...
      <span class="more"><a href="<?php echo urlShopWAP('pointvoucher', 'index');?>"><?php echo $lang['home_voucher_moretitle'];?></a></span> </div>
    ...
    <ul class="ncp-voucher-list">
      ...
      <li>
        <div class="ncp-voucher">
          <div class="cut"></div>
          <div class="info"><a href="<?php echo urlShopWAP('show_store', 'index', array('store_id'=>$v['voucher_t_store_id']));?>" class="store"><?php echo $v['voucher_t_storename'];?></a>
  ...
  <div class="ncp-main-layout mb30">
    <div class="title">
      ...
      <span class="more"><a href="<?php echo urlShopWAP('pointprod', 'plist');?>"><?php echo $lang['pointprod_list_more'];?></a></span> </div>
    ...
    <ul class="ncp-exchange-list">
      ...
      <li>
        <div class="gift-pic"><a target="_blank" href="<?php echo urlShopWAP('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>"> <img src="<?php echo $v['pgoods_image'] ?>" alt="<?php echo $v['pgoods_name']; ?>" /> </a></div>
        <div class="gift-name"><a href="<?php echo urlShopWAP('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank" tile="<?php echo $v['pgoods_name']; ?>"><?php echo $v['pgoods_name']; ?></a></div>
