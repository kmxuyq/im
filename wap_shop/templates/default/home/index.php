...
<head>
    ...
    <meta name="Keywords" content="怡美_怡美假日_怡美微商城"/>
...
<div id="MyScroller">
    ...
    <div class="header_top">
        ...
        <div class="top_sreach">
            <input class="address" id="addresData" value="昆明" type="button" />
            <div class="ipt_wrap">
                <span class="icon"></span>
                <input type="text" placeholder="目的地/景区/酒店/门票" />
            </div>
        </div>
    ...
    <div class="banner">
        <ul>
            <li><img src="<?php echo SHOP_TEMPLATES_URL;?>/style/images/banner_index.jpg" alt=""></li>
            <li><img src="" style="background: #f60" alt=""></li>
            <li><img src="<?php echo SHOP_TEMPLATES_URL;?>/style/images/banner_index.jpg" alt=""></li>
            <li><img src="<?php echo SHOP_TEMPLATES_URL;?>/style/images/banner_index.jpg" alt=""></li>
        </ul>
    </div>
    ...
    <div class="index_tab_wrap">
        <ul class="tab_tt">
            <li class="on"><em class="icon1"></em><span>我的周末</span></li>
            <li><em class="icon2"></em><span>我的假期</span></li>
        </ul>
        <div class="tab_body">
            <ul>
                <li class="cell"><a href="#" class="on">爬山</a></li>
                <li class="cell"><a href="#">烧烤</a></li>
                <li class="cell"><a href="#">民俗</a></li>
                <li class="cell"><a href="#">亲子</a></li>
                <li class="cell"><a href="#" class="on">爬山</a></li>
                <li class="cell"><a href="#">烧烤</a></li>
                <li class="cell"><a href="#">民俗</a></li>
                <li class="cell"><a href="#">亲子</a></li>
    ...
    <div class="list_wrap">
        <div class="product">
            ...
            <div class="title">天堂森林公园</div>
            <div class="product_view">
                <img class="view_img" src="<?php echo SHOP_TEMPLATES_URL;?>/style/images/product_img.jpg" alt="">
                <div class="view_content">
                    <div class="header">
                        <span class="sex_1"></span>
                        <img src="" alt="">
                        <span>鬼画符</span>
                    </div>
                    <div class="content">
                        ...
                        <div class="text">前几天去过，感觉还不错，推荐给大家！前几天去过，感觉还不错，推荐给大家！</div>
                    </div>
                </div>
            </div>
            <ul class="mark">
    ...
    <!--周边游主题推荐-->
    <div class="index_theme_title">
        周边游主题推荐
    </div>
    <!--周边游广告-->
    <div class="small_banner">
        <a href="#"><img src="<?php echo SHOP_TEMPLATES_URL;?>/style/images/index_zhouby.jpg" alt=""></a>
    </div>
    <div class="small_banner">
        <a href="#"><img src="<?php echo SHOP_TEMPLATES_URL;?>/style/images/index_zhouby.jpg" alt=""></a>
    </div>
    ...
    <div class="index_menu">
        <a class="nav_icon1" href="#">
            <span>首页</span>
        </a>
        <a class="nav_icon2" href="#">
            <span>行程助手</span>
        </a>
        <a class="nav_icon3" href="#">
            <span>客服中心</span>
        </a>
        <a class="nav_icon4" href="#">
            <span>我的</span>
        </a>
...
function banner(){
    var num=0;
    var maxLen=$('.banner ul li').length-1;
    if(maxLen <=1) return;
