  ...
  <div class="container">
    <div class="span-24" id="content">
      <div class="invite-bd">
        ...
        <div class="invite-rebate"><a href="<?php echo urlShopWAP('member_points','index');?>" target="_blank" hidefocus="true"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/invite/income.png"></a></div>
