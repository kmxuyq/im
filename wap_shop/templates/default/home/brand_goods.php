    ...
    <div class="nch-module nch-module-style01">
      ...
      <div class="content">
        ...
        <ul class="nch-sidebar-brand">
          ...
          <li class="picture"> <a href="<?php echo urlShopWAP('brand', 'list',array('brand'=>$brand_r['brand_id']));?>" target="_blank"> <span class="brand-logo"><img src="<?php echo brandImage($brand_r['brand_pic']);?>" alt="<?php echo $brand_r['brand_name'];?>" /></span> <span class="brand-name"><?php echo $brand_r['brand_name'];?></span></a> </li>
          <?php }?>
        </ul>
        <?php }?>
      </div>
      ...
      <div class="content">
        <div class="nch-sidebar-viewed" id="nchSidebarViewed">
          ...
          <?php if(!empty($output['viewed_goods'])){ ?>
            ...
            <li>
              <div class="goods-pic"><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$v['goods_id'])); ?>"><img src="<?php echo thumb($v, 60); ?>" title="<?php echo $v['goods_name']; ?>" alt="<?php echo $v['goods_name']; ?>" ></a></div>
              <dl>
                <dt><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$v['goods_id'])); ?>"><?php echo $v['goods_name']; ?></a></dt>
        ...
        <a href="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=member_goodsbrowse&op=list" class="nch-sidebar-all-viewed">全部浏览历史</a> </div>
    </div>
  </div>
  <div class="right">
