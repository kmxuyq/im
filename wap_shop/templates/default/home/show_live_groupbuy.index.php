  ...
  <div class="ncg-content">
    ...
    <div class="group-list mt20">
      <div class="ncg-recommend-title">
        <h3>商品抢购推荐</h3>
        <a href="<?php echo urlShopWAP('show_groupbuy', 'index');?>" class="more">查看更多</a></div>
    ...
    <div class="group-list mt30">
      <div class="ncg-recommend-title">
        <h3>线下抢购推荐</h3>
        <a href="<?php echo urlShopWAP('show_live_groupbuy', 'live_groupbuy_list');?>" class="more">查看更多</a></div>
      <?php if(!empty($output['live_groupbuy'])){?>
      <ul>
        <?php foreach($output['live_groupbuy'] as $groupbuy) { ?>
        <li class="<?php echo $output['current'];?>">
          <div class="ncg-list-content"> <a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" class="pic-thumb" target="_blank"><img src="<?php echo lgthumb($groupbuy['groupbuy_pic'],'mid');?>" alt=""></a>
            <h3 class="title"><a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" target="_blank"><?php echo $groupbuy['groupbuy_name'];?></a></h3>
            <div class="item-prices"> <span class="price"><i><?php echo $lang['currency'];?></i><em><?php echo $groupbuy['groupbuy_price'];?></em></span>
              ...
              <span class="sold-num"> <em><?php echo $groupbuy['buyer_num'];?></em>个<?php echo $lang['text_buy'];?> </span> <a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" target="_blank" class="buy-button">我要抢</a> </div>
          </div>
        </li>
        <?php } ?>
      </ul>
