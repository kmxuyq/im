        ...
        <div class="ncg-store-info">
          <dl class="name">
            ...
            <dd>
              ...
              <?php }else{?>
              <a href="<?php echo urlShopWAP('show_store', 'index', array('store_id'=>$output['store_info']['store_id']));?>" target="_blank"><?php echo $output['store_info']['store_name'];?></a>
              <?php }?>
            </dd>
          </dl>
    ...
    <div class="ncg-module-sidebar">
      ...
      <div class="content">
        ...
        <div class="ncg-group-command">
          ...
          <dl>
            <dt class="name"><a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$hot_groupbuy['groupbuy_id']));?>" target="_blank"><?php echo $hot_groupbuy['groupbuy_name'];?></a></dt>
            <dd class="pic-thumb"><a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$hot_groupbuy['groupbuy_id']));?>" target="_blank"><img src="<?php echo lgthumb($hot_groupbuy['groupbuy_pic'],'max');?>"></a></dd>
            <dd class="item"><a href="<?php echo urlShopWAP('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$hot_groupbuy['groupbuy_id']));?>" target="_blank"><?php echo $lang['to_see'];?></a> <span class="price"><?php echo $lang['currency'].$hot_groupbuy['groupbuy_price'];?></span> <span class="buy"><em><?php echo $hot_groupbuy['buyer_num'];?></em><?php echo $lang['text_piece'].$lang['text_buy'];?></span> </dd>
          </dl>
          <?php } ?>
        </div>
        <?php }else{?>
