  ...
  <div class="ncc-main">
    ...
    <table class="ncc-table-style">
      ...
      <tr id="pcart_item_<?php echo $v['pcart_id']; ?>">
        <td></td>
        <td class="w60"><a href="<?php echo urlShopWAP('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank" class="ncc-goods-thumb"><img src="<?php echo $v['pgoods_image_small']; ?>" alt="<?php echo $v['pgoods_name']; ?>"/></a></td>
        <td class="tl"><dl class="ncc-goods-info">
            <dt><a href="<?php echo urlShopWAP('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank"><?php echo $v['pgoods_name']; ?></a></dt>
          </dl></td>
    ...
    <div class="ncc-bottom"> <a href="index.php?act=pointcart&op=address" class="ncc-btn ncc-btn-acidblue fr"><?php echo $lang['pointcart_cart_submit']; ?></a> </div>
  </div>
  <?php } else { ?>
