...
<div class="qz-padding">猜您喜欢的宝贝</div>
...
<div class="goods-guess-like">
  <div class="content">
    ...
    <ul id="mycarousel" class="jcarousel-skin-tango">
      ...
      <li>
        <div class="goods-pic"> <a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$v['goods_id']));?>" target="_blank"><img alt="" src="<?php echo cthumb($v['goods_image'], 240);?>"></a> </div>
        ...
        <?php } ?>
        <dl class="goods-info">
          <dt><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>" target="_blank"><?php echo $v['goods_name'];?></a></dt>
          <dd>
