...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo urlShopWAP(); ?>">首页</a> </span> <span class="arrow">></span> <span>虚拟抢</span></div>
</div>
...
<?php } ?>
  ...
  <div class="ncg-content">
    <div class="ncg-nav">
      <ul>
        <li<?php if ($output['current'] == 'online') echo ' class="current"'; ?>><a href="<?php echo urlShopWAP('show_groupbuy', 'vr_groupbuy_list');?>">正在进行</a></li>
        <li<?php if ($output['current'] == 'soon') echo ' class="current"'; ?>><a href="<?php echo urlShopWAP('show_groupbuy', 'vr_groupbuy_soon');?>">即将开始</a></li>
        <li<?php if ($output['current'] == 'history') echo ' class="current"'; ?>><a href="<?php echo urlShopWAP('show_groupbuy', 'vr_groupbuy_history');?>">已经结束</a></li>
      </ul>
    </div>
