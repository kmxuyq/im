...
<section class="ui-container">
    <div class="qz-padding">订单已支付完成，祝您购物愉快<a href="<?php echo WAP_SHOP_SITE_URL?>/index.php?act=member_vr_order&op=show_order&order_id=<?php echo $output['order_id'];?>">查看订单详情</a></div>
    <div class="qz-padding qz-background-white qz-top-b qz-bottom-b">


        订单支付成功！您已成功支付订单金额￥<em style="color:#DA3228;font-size:18px;"><?php echo $output['order_amount'];?></em>，订单编号：<em style="color:#DA3228;font-size:18px;"><?php echo $_GET['order_sn'];?></em>。
        ...
        <div class="qz-ft-l qz-fl">
            ...
            <dl class="qz-fr"><a href="<?php echo WAP_SHOP_SITE_URL?>/index.php?act=member_vr_order" class="ui-btn-lg ui-btn-primary qz-btn-lg qz-background-yellow"><i class="icon-file-text-alt"></i>查看订单</a>
            </dl>
        </div>
