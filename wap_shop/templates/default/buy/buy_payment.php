 ...
 <div  id="paymentCon">
    <div class="ui-form qz-top-b qz-bottom-b" id="payment_list"  style="display:none">
     <div class="ui-form-item ui-form-item-radio">
		...
		<div><a href="javascript:void(0);" class="ui-btn ui-btn-lg ui-btn-primary qz-padding-30 qz-background-yellow" id="hide_payment_list">保存支付方式</a></div>
    </div>
	
	<div id="ncc-payment-showgoods-list" class="ncc-payment-showgoods-list" style="display: none;">
    <dl>
