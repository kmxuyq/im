  ...
  <div id="headRelative" class="ncg-topbar-wrapper">
    <div class="title" style="width:210px;">
      ...
      <div id="list" class="list" style="display:none;"><a id="button_close" class="close" href="javascript:void(0)">&#215;</a>
        <ul>
          <li><a href="<?php echo urlShopWAP('show_groupbuy', 'select_city'); ?>&back_op=<?php echo $_GET['op']; ?>&city_id=0"><?php echo $lang['text_country'];?></a></li>
          <?php $names = $output['groupbuy_vr_cities']['name']; foreach ($output['groupbuy_vr_cities']['children'][0] as $v) { ?>
          <li><a href="<?php echo urlShopWAP('show_groupbuy', 'select_city'); ?>&back_op=<?php echo $_GET['op']; ?>&city_id=<?php echo $v; ?>"><?php echo $names[$v]; ?></a></li>
          <?php } ?>
        </ul>
      </div>
      <?php } ?>
	...
	<!-- delete by tanzn start
    <ul class="nav-menu">
      <li><a href="<?php echo urlShopWAP('show_groupbuy', 'index'); ?>"<?php if (!isset($output['groupbuyMenuIsVr'])) echo ' class="current"'; ?>>抢购首页</a></li>
      <li><a href="<?php echo urlShopWAP('show_groupbuy', 'groupbuy_list'); ?>"<?php if (isset($output['groupbuyMenuIsVr']) && !$output['groupbuyMenuIsVr']) echo ' class="current"'; ?>>线上抢</a></li>
      <li><a href="<?php echo urlShopWAP('show_groupbuy', 'vr_groupbuy_list'); ?>"<?php if (isset($output['groupbuyMenuIsVr']) && $output['groupbuyMenuIsVr']) echo ' class="current"'; ?>>虚拟抢</a></li>
    </ul>
	delete by tanzn stop-->
  </div>
</div>
