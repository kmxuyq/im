...
<div id="topHeader">
  <div class="site-logo"><a href="<?php echo WAP_SHOP_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logo']; ?>"></a>  </div>
  <!--地区-->
...
<div id="navBar" class="mb10">
  <ul>
    <li class="fn-left link" <?php echo $output['index_sign'] == 'index' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo WAP_SHOP_SITE_URL;?>"><span><?php echo $lang['nc_index'];?></span><span class="line"></span></a></li>  
    <?php if (intval($GLOBALS['setting_config']['groupbuy_allow']) === 1){ ?>
    <li class="fn-left" <?php echo $output['index_sign'] == 'groupbuy' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=show_groupbuy"><span><?php echo $lang['nc_groupbuy'];?></span><span class="line"></span></a></li>
    <?php }?>  
    <li class="fn-left" <?php echo $output['index_sign'] == 'brand' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=brand"><span><?php echo $lang['nc_brand'];?></span><span class="line"></span></a></li>
      <?php if ($GLOBALS['setting_config']['points_isuse'] == 1 && $GLOBALS['setting_config']['pointprod_isuse'] == 1){ ?>
          <li class="fn-left" <?php echo $output['index_sign'] == 'pointprod' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=pointprod"><span><?php echo $lang['nc_pointprod'];?></span><span class="line"></span></a></li>
  <?php } ?>
