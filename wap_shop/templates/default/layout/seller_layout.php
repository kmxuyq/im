...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo WAP_SHOP_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var SHOP_RESOURCE_SITE_URL = '<?php echo SHOP_RESOURCE_SITE_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo SHOP_TEMPLATES_URL;?>';</script>
...
<!-- 增加日历插件 -->
<script type="text/javascript" src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/jedate/jedate.min.js"></script>
...
<header class="ncsc-head-layout w">
  <div class="wrapper">
    <div class="ncsc-admin">
      ...
      <div class="ncsc-admin-function"><a href="<?php echo urlShopWAP('show_store', 'index', array('store_id'=>$_SESSION['store_id']), $output['store_info']['store_domain']);?>" title="前往店铺" ><i class="icon-home"></i></a><a href="<?php echo urlShopWAP('member_security', 'auth',array('type'=>'modify_pwd'));?>" title="修改密码" target="_blank"><i class="icon-wrench"></i></a><a href="<?php echo urlShopWAP('seller_logout', 'logout');;?>" title="安全退出"><i class="icon-signout"></i></a></div>
    </div>
    <div class="center-logo"> <a href="<?php echo WAP_SHOP_SITE_URL;?>" target="_blank"><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('seller_center_logo');?>" class="pngFix" alt=""/></a>
      <h1>商家中心</h1>
...
$(document).ready(function(){
    ...
    $('[nctype="btn_add_quicklink"]').on('click', function() {
        ...
        if($quicklink_item.hasClass('selected')) {
            $.post("<?php echo urlShopWAP('seller_center', 'quicklink_del');?>", { item: item }, function(data) {
            ...
            if(count >= 8) {
                ...
                $.post("<?php echo urlShopWAP('seller_center', 'quicklink_add');?>", { item: item }, function(data) {
...
<div id="tbox">
  <div class="btn" id="msg"><a href="<?php echo urlShopWAP('store_msg', 'index');?>"><i class="msg"><?php if ($output['store_msg_num'] > 0) { ?><em><?php echo $output['store_msg_num'];?></em><?php } ?></i>站内消息</a></div>
