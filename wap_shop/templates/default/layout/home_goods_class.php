...
<script type="text/javascript">
    ...
    $(".qz-tcxz span").click(function(){
      ...
      <div class="title">
	  <i></i>
        <h3><a href="<?php echo urlShopWAP('category', 'index');?>"><?php echo $lang['nc_all_goods_class'];?></a></h3>
        </div>
      <div class="category">
        <ul class="menu">
          ...
          <li cat_id="<?php echo $val['gc_id'];?>" class="<?php echo $i%2==1 ? 'odd':'even';?>" <?php if($i>8){?>style="display:none;"<?php }?>>
            <div class="class">
              ...
              <?php } ?>
              <h4><a href="<?php echo urlShopWAP('search','index',array('cate_id'=> $val['gc_id']));?>"><?php echo $val['gc_name'];?></a></h4>
