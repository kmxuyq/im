...
$("select[name=area]").change(function(){
    ...
    $('#btn_search_goods').on('click', function() {
        var url = "<?php echo urlShopWAP('store_groupbuy', 'search_vr_goods'); ?>";
    ...
    $('#div_goods_search_result').on('click', '[nctype="btn_add_groupbuy_goods"]', function() {
        ...
        $.get('<?php echo urlShopWAP('store_groupbuy', 'groupbuy_goods_info'); ?>', {goods_commonid: goods_commonid}, function(data) {
            if(data.result) {
    ...
    $('[nctype="btn_upload_image"]').fileupload({
        dataType: 'json',
            url: "<?php echo urlShopWAP('store_groupbuy', 'image_upload');?>",
            add: function(e, data) {
    ...
    jQuery.validator.methods.checkGroupbuyGoods = function(value, element) {
        ...
        $.ajax({
            type:"GET",
            url:'<?php echo urlShopWAP('store_groupbuy', 'check_groupbuy_goods');?>',
            async:false,
