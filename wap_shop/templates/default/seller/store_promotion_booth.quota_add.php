...
<div class="ncsc-form-default">
  ...
  <form id="add_form" action="<?php echo urlShopWAP('store_promotion_booth', 'booth_quota_add');?>" method="post">
  <?php } else {?>
  <form id="add_form" action="<?php echo urlShopWAP('store_promotion_booth', 'booth_renew');?>" method="post">
  <?php }?>
