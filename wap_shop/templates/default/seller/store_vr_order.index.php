...
<div class="tabmenu">
  ...
  <a href="<?php echo urlShopWAP('store_vr_order', 'exchange');?>" class="ncsc-btn ncsc-btn-orange"><i class="icon-edit"></i>兑换兑换码</a>
</div>
...
<table class="ncsc-default-table order">
  ...
  <tbody>
    ...
    <tr>
      <td class="bdl"></td>
      <td class="w70"><div class="ncsc-goods-thumb"><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$order['goods_id']));?>" target="_blank"><img src="<?php echo thumb($order,60);?>" onMouseOver="toolTip('<img src=<?php echo thumb($order,240);?>>')" onMouseOut="toolTip()"/></a></div></td>
      <td class="tl"><dl class="goods-name">
          <dt><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=>$order['goods_id']));?>"><?php echo $order['goods_name']; ?></a></dt>
          <dd>
