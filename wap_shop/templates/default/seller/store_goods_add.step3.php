...
<?php }?>
<form method="post" id="goods_image" action="<?php if ($output['edit_goods_sign']) { echo urlShopWAP('store_goods_online', 'edit_save_image'); } else { echo urlShopWAP('store_goods_add', 'save_image');}?>">
