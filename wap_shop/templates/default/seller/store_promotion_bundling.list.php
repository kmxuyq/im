...
<table class="ncsc-default-table">
  ...
  <tbody>
    <tr class="bd-line">
      ...
      <td><div class="pic-thumb"><a <?php if ($val['goods_id'] != '') {echo 'href="' . urlShopWAP('goods', 'index', array('goods_id' => $val['goods_id'])) . '" target="_blank"';} else { echo 'href="javascript:void(0);"';}?> target="black"><img src="<?php echo $val['img'];?>"/></a></div></td>
      <td class="tl"><dl class="goods-name">
          <dt><a <?php if ($val['goods_id'] != '') {echo 'href="' . urlShopWAP('goods', 'index', array('goods_id' => $val['goods_id'])) . '" target="_blank"';} else { echo 'href="javascript:void(0);"';}?>><?php echo $val['bl_name'];?></a></dt>
        </dl></td>
      ...
      <td class="nscs-table-handle"><span><a href="index.php?act=store_promotion_bundling&op=bundling_add&bundling_id=<?php echo $val['bl_id'];?>" class="btn-blue"><i class="icon-cog"></i>
        ...
        </a></span> <span><a class="btn-red" href='javascript:void(0);' onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', '<?php echo urlShopWAP('store_promotion_bundling', 'drop_bundling', array('bundling_id' => $val['bl_id']));?>');"><i class="icon-trash"></i>
