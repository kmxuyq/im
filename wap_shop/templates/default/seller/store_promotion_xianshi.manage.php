...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_search_goods').on('click', function() {
            var url = "<?php echo urlShopWAP('store_promotion_xianshi', 'goods_select');?>";
        ...
        $('#div_goods_search_result').on('click', '#btn_submit', function() {
            ...
            if(!isNaN(xianshi_price) && xianshi_price > 0 && xianshi_price < goods_price) {
                $.post('<?php echo urlShopWAP('store_promotion_xianshi', 'xianshi_goods_add');?>', 
        ...
        $('#btn_edit_xianshi_goods_submit').on('click', function() {
            ...
            if(!isNaN(xianshi_price) && xianshi_price > 0 && xianshi_price < goods_price) {
                $.post('<?php echo urlShopWAP('store_promotion_xianshi', 'xianshi_goods_price_edit');?>',
        ...
        $('#xianshi_goods_list').on('click', '[nctype="btn_del_xianshi_goods"]', function() {
            ...
            if(confirm('确认删除？')) {
                var xianshi_goods_id = $(this).attr('data-xianshi-goods-id');
                $.post('<?php echo urlShopWAP('store_promotion_xianshi', 'xianshi_goods_delete');?>',
