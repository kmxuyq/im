...
<form id="spec_form" method="post" action="<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=store_spec&op=save_spec">
...
$(function(){
    ...
    $('a[nctype="submit-btn"]').click(function(){
        ...
        if (_submit) {
            ajaxpost('spec_form', '<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=store_spec&op=save_spec', '', 'onerror');
        }
    });
