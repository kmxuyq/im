  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="tl"><?php echo $val['complain_id'];?></td>
        <td class="w50"><div class="pic-thumb"><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=> $goods['goods_id'])); ?>">
            <img src="<?php echo thumb($goods,60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($goods,240); ?>>')" onMouseOut="toolTip()" /></a></div></td>
        <td class="tl"><dl class="goods-name">
            <dt><a target="_blank" href="<?php echo urlShopWAP('goods','index',array('goods_id'=> $goods['goods_id'])); ?>"><?php echo $goods['goods_name']; ?></a></dt>
