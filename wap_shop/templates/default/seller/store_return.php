...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line" >
        <td></td>
        <td class="w50"><div class="pic-thumb"><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=> $val['goods_id']));?>" target="_blank">
		...
		<dl class="goods-name"><dt><a href="<?php echo urlShopWAP('goods','index',array('goods_id'=> $val['goods_id']));?>" target="_blank"><?php echo $val['goods_name']; ?></a></dt>
