...
<div class="tabmenu">
  ...
  <a href="<?php echo urlShopWAP('store_plate', 'plate_add');?>" class="ncsc-btn ncsc-btn-green" title="添加关联版式">添加关联版式</a>
</div>
  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="10"><label for="all" ><?php echo $lang['nc_select_all'];?></label>
        <a href="javascript:void(0);" nc_type="batchbutton" uri="<?php echo urlShopWAP('store_plate', 'drop_plate');?>" name="p_id" confirm="<?php echo $lang['nc_ensure_del'];?>" class="ncsc-btn-mini"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a>
      </td>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
        <span><a href="<?php echo urlShopWAP('store_plate', 'plate_edit', array('p_id' => $val['plate_id']));?>" class="btn-blue"><i class="icon-edit"></i><p><?php echo $lang['nc_edit'];?></p></a></span>
        <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', '<?php echo urlShopWAP('store_plate', 'drop_plate', array('p_id' => $val['plate_id']));?>');" class="btn-red"><i class="icon-trash"></i><p><?php echo $lang['nc_del'];?></p></a></span>
      </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
