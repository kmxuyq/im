  ...
  <form method="post"  action="index.php?act=store_setting&op=store_setting" enctype="multipart/form-data" id="my_store_form">
    ...
    <!--//zmr>v30-->
     <dl>
      <dt>店铺二维码：</dt>
      <dd>
         <p><img src="<?php echo storeQRCode($output['store_info']['store_id']);?>"  title="商品原始地<?php echo urlShopWAP('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id']));?>"></p>
