...
<?php if ($output['isOwnShop']) { ?>
    <a class="ncsc-btn ncsc-btn-green" href="<?php echo urlShopWAP('store_voucher', 'templateadd');?>"><i class="icon-plus-sign"></i><?php echo $lang['voucher_templateadd']; ?></a>

<?php } else { ?>
    <?php if(!empty($output['current_quota'])) { ?>
    <a class="ncsc-btn ncsc-btn-green" style="right:100px" href="<?php echo urlShopWAP('store_voucher', 'templateadd');?>"><i class="icon-plus-sign"></i><?php echo $lang['voucher_templateadd']; ?></a>
    <a class="ncsc-btn ncsc-btn-acidblue" href="<?php echo urlShopWAP('store_voucher', 'quotaadd');?>" title=""><i class="icon-money"></i>套餐续费</a>
    <?php } else { ?>
    <a class="ncsc-btn ncsc-btn-acidblue" href="<?php echo urlShopWAP('store_voucher', 'quotaadd');?>" title=""><i class="icon-money"></i>购买套餐</a>
    <?php } ?>
