  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="nscs-table-handle">
          <span><a id="a_<?php echo $v['activity_id'];?>" href="index.php?act=store_activity&op=activity_apply&activity_id=<?php echo $v['activity_id'];?>"  class="btn-green"><i class="icon-edit"></i>
