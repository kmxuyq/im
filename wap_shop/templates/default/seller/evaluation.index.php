...
<div class="tabmenu">
    <ul id="listpj" class="tab">
        <li class="active"><a href="<?php echo urlShopWAP('store_evaluate', 'list');?>"><?php echo $lang['member_evaluation_frombuyer'];?></a></li>
    </ul>
</div>
<form method="get">
...
<table class="ncsc-default-table">
    ...
    <tbody>
        ...
        <tr>
            <th></th>
            <th>
                <span class="goods-name"><a target="_blank" href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $v['geval_goodsid']));?>"><?php echo $v['geval_goodsname']?></a></span>
...
$(document).ready(function(){
    ...
    $('#btn_explain_submit').on('click', function() {
        if($('#explain_form').valid()){
            ...
            $.post("<?php echo urlShopWAP('store_evaluate', 'explain_save');?>",{
                geval_id: geval_id,
