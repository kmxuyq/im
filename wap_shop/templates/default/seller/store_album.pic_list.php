...
$(function() {
    ...
    $('input[nctype="replace_image"]').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: '<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=store_album&op=replace_image_upload&id=' + $(this).attr('id'),
    ...
    $('#fileupload').fileupload({
        dataType: 'json',
        url: '<?php echo WAP_SHOP_SITE_URL;?>/index.php?act=store_album&op=image_upload',
        add: function (e,data) {
...
function submit_form(type){
	...
	$('#checkboxform').attr('action','<?php echo WAP_SHOP_SITE_URL?>/index.php?act=store_album&op=album_pic_'+type);
