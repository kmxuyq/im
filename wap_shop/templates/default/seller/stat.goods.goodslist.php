...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      <td><div class="pic-thumb"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $v['goods_id']));?>" target="_blank"><img src="<?php echo thumb($v, 60);?>"/></a></div></td>
      <td class="tl"><span class="over_hidden w400 h20"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $v['goods_id']));?>" target="_blank"><?php echo $v['goods_name'];?></a></span></td>
