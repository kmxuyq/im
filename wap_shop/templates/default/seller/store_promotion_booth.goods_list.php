...
<?php } else { ?>
  ...
  <a class="ncsc-btn ncsc-btn-acidblue" href="<?php echo urlShopWAP('store_promotion_booth', 'booth_quota_add');?>" title="购买套餐"><i class="icon-money"></i>购买套餐</a>
  <?php } else { ?>
  ...
  <?php } ?>
  <a class="ncsc-btn ncsc-btn ncsc-btn-acidblue" href="<?php echo urlShopWAP('store_promotion_booth', 'booth_renew');?>"><i class="icon-money"></i>套餐续费</a>
  <?php } ?>
<?php } ?>
...
$(function(){
    ...
    $('input[nctype="btn_search_goods"]').click(function(){
        _url = '<?php echo urlShopWAP('store_promotion_booth', 'booth_select_goods');?>';
    ...
    $('div[nvtype="div_goods_select"]').on('click', 'a[nctype="a_choose_goods"]', function(){
        _url = '<?php echo urlShopWAP('store_promotion_booth', 'choosed_goods');?>';
    ...
    $('tbody[nctype="choose_goods_list"]').on('click','a[nctype="del_choosed"]', function(){
        $this = $(this);
        _url = '<?php echo urlShopWAP('store_promotion_booth', 'del_choosed_goods');?>';
        eval('var data_str = ' + $(this).attr('data-param'));
        $.getJSON(_url, {gid : data_str.gid}, function(data){
            if (data.result == 'true') {
