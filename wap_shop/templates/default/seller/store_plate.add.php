...
<div class="ncsc-form-default">
  <form method="post" action="<?php if (empty($output['plate_info'])) { echo urlShopWAP('store_plate', 'plate_add');} else { echo urlShopWAP('store_plate', 'plate_edit');}?>" id="plate_form">
