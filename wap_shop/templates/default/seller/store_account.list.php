  ...
  <tbody>
    ...
    <td></td>
      ...
      <td class="nscs-table-handle">
          <span><a href="<?php echo urlShopWAP('store_account', 'account_edit', array('seller_id' => $value['seller_id']));?>" class="btn-blue"><i class="icon-edit"></i>
...
<form id="del_form" method="post" action="<?php echo urlShopWAP('store_account', 'account_del');?>">
