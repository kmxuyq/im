    ...
    <div class="basic-info">
      <dl class="ncsc-seller-info">
        ...
        <dd class="store-logo">
          ...
          <a href="<?php echo urlShopWAP('store_setting', 'store_setting');?>"><i class="icon-edit"></i>编辑店铺设置</a> </dd>
        ...
        <dd class="store-name"><?php echo $lang['store_name'].$lang['nc_colon'];?><a href="<?php echo urlShopWAP('show_store', 'index', array('store_id' => $_SESSION['store_id']), $output['store_info']['store_domain']);?>" ><?php echo $output['store_info']['store_name'];?></a></dd>
      ...
      <div class="content">
        <ul>
          <?php
			...
			?>
          <li><a target="_blank" href="<?php echo urlShopWAP('show_help', 'index', array('t_id' => $val['type_id']));?>" title="<?php echo $val['type_name']; ?>">
        ...
        <table class="ncsc-default-table">
          ...
          <tbody>
            ...
            <tr class="bd-line">
              ...
              <td class="w60"><div class="pic-thumb"><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $val['goods_id']))?>" target="_blank"><img alt="<?php echo $val['goods_name'];?>" src="<?php echo thumb($val, '60');?>"></a></div></td>
              <td><dl class="goods-name">
                  <dt><a href="<?php echo urlShopWAP('goods', 'index', array('goods_id' => $val['goods_id']))?>" target="_blank"><?php echo $val['goods_name'];?></a></dt>
                </dl></td>
