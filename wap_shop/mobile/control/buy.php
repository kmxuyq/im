...
class buyControl extends BaseBuyControl {
    ...
    public function buy_step2Op() {
		...
		//转向到商城支付页面
      redirect('index.php?act=buy&op=pay&pay_sn='.$result['data']['pay_sn'].'&goods_name='.$_POST['goods_name']);
		// $pay_url = 'index.php?act=buy&op=pay&pay_sn='.$result['data']['pay_sn'].'&goods_name='];
      //  redirect($pay_url)
    }
