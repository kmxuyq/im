...
class Common_util_pub
{
	...
	var $SITEURL;     		//$SITEURL
	var $APPID;       		//$APPID
	var $MCHID;       		//$MCHID 支付的商户号
	var $KEY;               //$KEY 支付的KEY
	var $APPSECRET;         //$APPSECRET 支付的KEY
	var $JS_API_CALL_URL;   //$JS_API_CALL_URL发起路径
	var $NOTIFY_URL;   		//$NOTIFY_URL回调路径
	var $SSLCERT_PATH;      //$SSLCERT_PATH 证书路径
	var $SSLKEY_PATH;       //$SSLKEY_PATH  证书路径
	
	function __construct() {
	}
    
	//对参数赋值
	public function setWxParam($data){
		$this->SITEURL 		= $data['SITEURL'];
		$this->APPID 		= $data['APPID'];
		$this->MCHID 		= $data['MCHID'];
		$this->KEY 			= $data['KEY'];
		$this->APPSECRET 	= $data['APPSECRET'];
		$this->JS_API_CALL_URL 	= $data['JS_API_CALL_URL'];
