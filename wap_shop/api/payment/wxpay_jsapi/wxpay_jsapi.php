...
class wxpay_jsapi
{
    ...
    public function __construct()
    {
        $this->config = (object) array(
            'appId' => 'wxcd21bb7c0246f914',
            'appSecret' => 'cbdc538ba1d407c526ca448bfed84f77',
            'partnerId' => '1346343401',
            'apiKey' => '3npOdRsGipv82upjyBXQZqr6QrLcfulW',

            'notifyUrl' => BASE_SITE_URL . '/yydb/api/payment/wxpay_jsapi/notify_url.php',
            'finishedUrl' => BASE_SITE_URL . '/yydb/index.php',
            //'undoneUrl' => BASE_SITE_URL . '/yydb/index.php',
            'undoneUrl' => 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxcd21bb7c0246f914&redirect_uri='.BASE_SITE_URL.'/yydb/index.php&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect',
            'orderSn' => date('YmdHis'),
