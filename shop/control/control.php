...
class BaseSellerControl extends Control
{
    ...
    public function __construct()
    {
        ...
        if ('seller_login' !== $_GET['act']) {
            ...
            $menu_list       = $this->_getMenuList();
            $child_menu_list = array_column($menu_list, "child");

            if (!empty($_SESSION['seller_limits']) && $_SESSION['seller_is_admin'] != 1) {
                $seller_limits = $_SESSION['seller_limits'];
                //删除无权限的栏目
                foreach ($child_menu_list as $key => $value) {
                    foreach ($value as $k => $v) {
                        if (!in_array($v['act'], $seller_limits)) {
                            unset($child_menu_list[$key][$k]);
                        }
                    }
                }
                $i = 0;
                foreach ($menu_list as $kk => $vv) {
                    $menu_list[$kk]['child'] = $child_menu_list[$i];
                    $i++;
                }
    ...
    private function _getMenuList()
    {
        $menu_list = array(
            ...
            'order'      => array('name' => '订单物流', 'child' => array(
                ...
                array('name' => '票务交易订单', 'act' => 'store_station_order', 'op' => 'index'),
                ...
                array('name' => '支付流水', 'act' => 'store_pay_log', 'op' => 'pay_log_list'),
            )),
            'promotion'  => array('name' => '促销', 'child' => array(
                ...
                array('name' => '精彩活动审核', 'act' => 'active_chick', 'op' => 'index'),
                array('name' => '免费申领试用审核', 'act' => 'appaly_chick', 'op' => 'index'),
                array('name' => '微信活动中奖', 'act' => 'wx_prize', 'op' => 'index'),
                array('name' => '促销活动', 'act' => 'pro_activity', 'op' => 'index'),
                array('name' => '首页分类按钮', 'act' => 'index_btn', 'op' => 'index'),
            )),
            'store'      => array('name' => '店铺', 'child' => array(
                ...
                array('name' => '精彩VR', 'act' => 'videos', 'op' => 'index'),
            )),
            ...
            'statistics' => array('name' => '统计结算', 'child' => array(
                ...
                array('name' => '门店订单', 'act' => 'store_gf_order', 'op' => 'index'),
                array('name' => '导购下线', 'act' => 'store_gf_shopping_guide_lower', 'op' => 'index'),
                array('name' => '抽奖码', 'act' => 'store_gf_luck_draw_code', 'op' => 'index'),
            )),
            ...
            'weixin'     => array('name' => '微信管理', 'child' => array(
                array('name' => '微信配置信息', 'act' => 'store_wx_info', 'op' => 'index'),
                array('name' => '消息模板', 'act' => 'store_wx_message', 'op' => 'index'),
                array('name' => '自定义菜单', 'act' => 'store_wx_menu', 'op' => 'index'),
                array('name' => '会员管理', 'act' => 'store_wx_member', 'op' => 'index'),
                array('name' => '活动规则', 'act' => 'store_wx_active_rule', 'op' => 'index'),
                array('name' => '订单管理', 'act' => 'store_wx_order', 'op' => 'index'),
                array('name' => '自动回复', 'act' => 'store_wx_auto_reply', 'op' => 'index'),
            )),
            'share'      => array('name' => '分销商城', 'child' => array(
                array('name' => '系统设置', 'act' => 'share_settings', 'op' => 'index'),
                array('name' => '商品管理', 'act' => 'share_goods', 'op' => 'index'),
                array('name' => '实物订单管理', 'act' => 'share_order', 'op' => 'index'),
                array('name' => '虚拟订单管理', 'act' => 'share_vr_order', 'op' => 'index'),
                array('name' => '会员管理', 'act' => 'share_member', 'op' => 'index'),
                array('name' => '广告管理', 'act' => 'share_adv', 'op' => 'index'),
                array('name' => '数据统计', 'act' => 'share_static', 'op' => 'index'),
                array('name' => '佣金管理', 'act' => 'share_apply', 'op' => 'index'),
                array('name' => '分销申请', 'act' => 'share_confirm', 'op' => 'index'),
            )),
        );
        return $menu_list;
    }
