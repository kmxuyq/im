...
//        print_r($xianshi_goods_list);exit;
    ...
    public function getGroupbuyOnlineList($condition, $page = null, $order = 'state asc', $field = '*') {
        ...
        return $this->getXianshiGoodsExtendList($condition, $page, $order, $field);
    }
...
//        $xianshi_info['image_url'] = cthumb($xianshi_info['goods_image'], 120, $xianshi_info['store_id']);
        $xianshi_info['image_url'] = UPLOAD_SITE_URL.'/shop/store/goods/'.$xianshi_info['store_id'].'/'.$xianshi_info['goods_image'];//商品大图
        ...
        if($xianshi_info['start_time'] > TIMESTAMP) {
            $xianshi_info['state_flag'] = 'not-start';
            $xianshi_info['button_text'] = '未开始';
            $xianshi_info['count_down_text'] = '距抢购开始';
            $xianshi_info['count_down'] = $xianshi_info['start_time'] - TIMESTAMP;
        } elseif ($xianshi_info['end_time'] < TIMESTAMP) {
            $xianshi_info['state_flag'] = 'close';
            $xianshi_info['button_text'] = '已结束';
        } else {
            $xianshi_info['state_flag'] = 'buy-now';
            $xianshi_info['button_text'] = '我要抢';
            $xianshi_info['count_down_text'] = '距抢购结束';
            $xianshi_info['count_down'] = $xianshi_info['end_time'] - TIMESTAMP;
        }
        return $xianshi_info;
    }
