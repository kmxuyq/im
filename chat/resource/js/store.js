	...
	function store_goods_info(f_id) { //只在商家中心显示来源商品信息
	    ...
	    if (typeof user_chat_goods[f_id] === "object") {
	        ...
	        goods_html += '<input type="hidden" id="goods_id" value="' + goods['goods_id'] + '"></input>';
	        goods_html += '<div class="goods-pic"><a target="_blank" href="/wap_shop/index.php?act=goods&op=index&goods_id=' + goods['goods_id'] + '">';
	        goods_html += '<img src="' + goods['pic'] + '"></a></div>';
	        goods_html += '<div class="goods-price">&yen;' + goods['goods_promotion_price'] + '</div>';
	        goods_html += '<div class="goods-name"><a class="goods_pic" target="_blank" href="/wap_shop/index.php?act=goods&op=index&goods_id=' + goods['goods_id'] + '">';
